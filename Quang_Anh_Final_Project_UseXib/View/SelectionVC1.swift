...
class SelectionVC1: UIViewController {

    private var titleLabel: UILabel = {
        let label = UILabel()
        label.text = "Which heart health issue \nconcerns you the most?"
    ...
    @objc private func didTapContinue() {
        ...
        let nextVC = SelectionVC2() // Thay bằng màn hình kế tiếp của bạn
        navigationController?.pushViewController(nextVC, animated: true)
    }
}

// MARK: - UICollectionViewDataSource & Delegate
extension SelectionVC1: UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
